    ...
    return (
        <div className="cta-section section section-padding-250">
            <div className="container text-center icon-up-down-animation">
                <SectionTitle
                    headingOption="fz-34"
                    title="Let's talk about your situation and see how we can work together"
                    subTitle="Our professional care team has expertise in providing high-quality medical management and restorative care to patients with catastrophic injuries or illnesses who love what they do and love where they work."
                />
