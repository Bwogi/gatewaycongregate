                ...
                <div className="row">
                    ...
                    <div className="col-xl-5 col-lg-6 order-lg-1 order-2" data-aos="fade-up">
                        ...
                        <div className="progressbar-area mt-lg-0 mt-md-50 mt-sm-50 mt-40">
                            ...
                            <SectionTitleTwo 
                                subTitle="Supportive Care with Dignity"
                                title="Our health management services"
                            />

                            <div className="progress-bar--one">
                                <div className="progress-charts">
                                    <h6 className="heading ">Medical Supervision</h6>
                                ...
                                <div className="progress-charts ">
                                    <h6 className="heading ">24-hour Skilled Nursing</h6>
                                    <div className="single-progress">
                                ...
                                <div className="progress-charts ">
                                    <h6 className="heading ">Medical Management</h6>
                                    <div className="single-progress">
                                ...
                                <div className="progress-charts ">
                                    <h6 className="heading ">Nutritional Assessment</h6>
                                    <div className="single-progress">
                                ...
                                <div className="progress-charts ">
                                    <h6 className="heading ">Counseling</h6>
                                    <div className="single-progress">
                                        <ProgressBar data-aos="fade-right" data-aos-delay="100" data-aos-duration="450" className="gradient-4" now="81" label={<span>81%</span>} />
                                    </div>
                                </div>
                                ...
                                <div className="progress-charts ">
                                    <h6 className="heading ">Physical Therapy</h6>
                                    <div className="single-progress">
                                        <ProgressBar data-aos="fade-right" data-aos-delay="100" data-aos-duration="450" className="gradient-4" now="81" label={<span>81%</span>} />
                                    </div>
                                </div>
